...
import com.example.imgedit.cameralibrary.listener.ReturnListener;
import com.example.imgedit.cameralibrary.listener.TypeListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    private void initView() {
        ...
        txt_tip.setText("拍照");
        txt_tip.setTextColor(ContextCompat.getColor(getContext(), R.color.white));
