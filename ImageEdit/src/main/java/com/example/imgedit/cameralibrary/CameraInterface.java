...
import com.example.imgedit.cameralibrary.util.AngleUtil;
import com.example.imgedit.cameralibrary.util.CameraParamUtil;
import com.example.imgedit.cameralibrary.util.CheckPermission;
import com.example.imgedit.cameralibrary.util.DeviceUtil;
    ...
    private synchronized void openCamera(int id) {
        ...
        if (this.mCamera != null) {
            try {
                ...
                e.printStackTrace();
                LogUtil.e("enable shutter sound faild");
            }
        }
    }
